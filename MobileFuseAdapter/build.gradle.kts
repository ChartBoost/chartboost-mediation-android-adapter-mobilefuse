...
android {
    namespace = "com.chartboost.mediation.mobilefuseadapter"
    compileSdk = 33
    ...
    defaultConfig {
        ...
        android.defaultConfig.versionName = System.getenv("VERSION_OVERRIDE") ?: "4.1.7.0.0"
...
dependencies {
    ...
    // Partner SDK
    implementation("com.mobilefuse.sdk:mobilefuse-sdk-core:1.7.0")
...
artifactory {
    ...
    publish {
        ...
        defaults {
            publications("MobileFuseAdapter", "aar")
        ...
        publications {
            register<MavenPublication>("remoteRelease") {
                ...
                pom {
                    ...
                    scm {
                        val gitUrl = "https://github.com/ChartBoost/chartboost-mediation-android-adapter-mobilefuse"
                        url.set(gitUrl)
